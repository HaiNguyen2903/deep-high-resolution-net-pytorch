...
class Custom2DPoseDataset(JointsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
    ...
    def _load_coco_keypoint_annotation_kernal(self, index):
        ...
        '''
        replace the getAnnIds function
        '''
        # init param
        # imgIds = '{:06}'.format(index)
        # iscrowd = False
        ...
        #         lists = []
        #         for id in imgIds:
        #             lists.append(self.coco.imgToAnns[id])
    ...
    def evaluate(self, cfg, preds, output_dir, all_boxes, img_path,
        ...
        for idx, kpt in enumerate(preds):
            _kpts.append({
                ...
                'image': int(osp.basename(img_path[idx]).split('.')[0]) 
            })
