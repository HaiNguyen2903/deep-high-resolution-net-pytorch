...
if __name__ == '__main__':
    ...
    dst_root = '/home/ducanh/hain/dataset/custom_2d_coco_format'

    detection_save_path = f'{dst_root}/2dtrack_val_human_detections.json'
    poseval_save_path = f'{dst_root}/annotations/2dtrack_val.json'
    posetrain_save_path = f'{dst_root}/annotations/2dtrack_train.json'
    ...
    mkdir_if_missing(dst_root)
    mkdir_if_missing(osp.join(dst_root, 'annotations'))
